    ...
    providers: [
        CredentialsProvider({
            ...
            async authorize(credentials): Promise<User | null> {
                ...
                try {
                    const user = await getUserForAuthentication(credentials.email as string)
                    ...
                    const passwordValid = await compare(String(credentials.password), String(user.password))
