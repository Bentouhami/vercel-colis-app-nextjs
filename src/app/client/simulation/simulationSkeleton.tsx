...
const SimulationSkeleton = () => {
    return (
        <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="container mx-auto p-8 mt-10 bg-gray-50 dark:bg-gray-900 rounded-lg shadow-lg space-y-8"
        >
            <style>{`
                @keyframes shimmer {
            ...
            <motion.h2
                ...
                className="text-center text-3xl font-bold text-blue-600 dark:text-blue-400"
            >
            </motion.h2>

            <div className="max-w-4xl mx-auto p-6 space-y-6 mb-52 bg-gray-50 dark:bg-gray-900 rounded-lg shadow-lg">
                {/* Departure Info */}
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
