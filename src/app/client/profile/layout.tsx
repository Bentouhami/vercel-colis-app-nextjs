...
export default function ProfileLayout({
    ...
    return (
        <RequireAuth allowedRoles={[RoleDto.SUPER_ADMIN, RoleDto.AGENCY_ADMIN, RoleDto.ACCOUNTANT, RoleDto.CLIENT]}>
            <SidebarProvider>
                <div
                    className="w-full flex justify-center items-start min-h-screen bg-gray-100 dark:bg-gray-900 pt-16 relative">
                    <div
                        className="flex w-full max-w-5xl min-h-[80vh] bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
